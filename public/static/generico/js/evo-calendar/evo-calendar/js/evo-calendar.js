...
;(function(factory) {
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup += '></div></div><div class="event-info"><p class="event-title">'+_.limitTitle(event_data.name,36);
    ...
    EvoCalendar.prototype.addEventIndicator = function(event) {
        ...
        function appendDot(date) {
            ...
            if(thisDate.find('span.event-indicator > .type-bullet > .type-'+type).length < 5)
            {
            ...
            if(thisDate.find('span.event-indicator > .type-bullet > .type-'+type).length == 5)
            {
              htmlToAppend = '<div class="type-bullet" style="line-height: 0.8;"><div ';

              htmlToAppend += 'class="type-'+event.type+'" style="background-color:'+event.color+';background-color: transparent; font-size: 14px;" '
              htmlToAppend += '>+</div></div>';
              thisDate.find('.event-indicator').append(htmlToAppend);
            }
