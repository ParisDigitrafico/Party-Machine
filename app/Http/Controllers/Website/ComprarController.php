...
use App\Models\CncConvencion;
use App\Models\CncCarnet;
use App\Models\CncInscripcion;
use App\Models\CncVuelo;
use App\Models\CncHospedaje;

use App\Models\CatSector;
use App\Models\CatDelegacion;

use App\Models\GenArchivo;

use App\Services\SystemService;

class ComprarController extends MController
{
  ...
  public function ShowCarrito(Request $request)
  {
    ...
    $arrRes = $objLocalServ->get_pedidos(1);

    $response["data"] = $arrRes["data"];

    return view("website.comprar.carrito_form", $response)->render();
  }
