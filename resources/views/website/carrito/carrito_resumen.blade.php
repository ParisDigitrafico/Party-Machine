    ...
    <div class="container area_resumen_carrito">
        ...
        <div class="row">
          ...
          ?>
                ...
                <p>El horario para entregas a domicilio es de: {{ horaEspaniol($horaRepartoInicia) }} a
                    {{ horaEspaniol($horaRepartoTermina) }} por su comprensión gracias. </p>
                @endif
                ...
                <div class="border">
                    <div class="area_opciones" style="padding-left: 10px;">
                        ...
                        @if($currentTime >= $startTime && $endTime >= $currentTime)
                        <label style="padding: 5px;"><input type="radio" name="formaentrega"
                                class="checkradios radio-entrega optEntrega" value="domicilio" />&nbsp;<b>Entrega a
                                Domicilio</b></label>
                        @endif

                        <label style="padding: 5px; padding-left: 0;"><input type="radio" name="formaentrega"
                                class="checkradios radio-entrega optEntrega" value="farmacia" />&nbsp;<b>Recoger en
                                Farmacia</b></label>
                    </div>
                    ...
                    <div class="row forma_entrega forma_entrega_direcciones">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title" style="line-height: 1.2;"><label><input type="radio"
                                                name="direccion" class="optDireccion checkradios radio-direccion"
                                                value="{{ $direccion['id'] }}" />&nbsp;<span
                                                style="font-weight: bold">{{ $colonia["descripcion"] }},
                                                {{ $colonia["municipio"] }}</span></label></h5>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Es necesario agregar una dirección de entrega, <a
                                            href="/cliente/direcciones/" style="text-decoration:underline;">agrega una
                                            ahora</a>.</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body plugin_mapa">
                                    <h5 class="card-title"><span style="font-size: 14pt">Para continuar con la forma de
                                            entrega en farmacia, es necesario
                                            ubicar el punto donde desea recojer su pedido.</span></h5>

                                    <input type="hidden" id="codigoSucursal" name="codigoSucursal" value="" />

                                    <div>
                                        <h4 id="farmacia_nombre"></h4>
                                    </div>
                                    <div>
                                        <h4 id="farmacia_direccion"></h4>
                                    </div>
                                    <div>
                                        <h4 id="farmacia_codigo_postal"></h4>
                                    </div>

                                    <div style="text-align: right"><button class="btnEdit btnAzul"
                                            data-codigo-sucursal="">Buscar</button></div><br>
                                ...
                                <table class="table site-block-order-table mb-5" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right"><b>{{ number_format($row["precio"],2) }}</b>
                                            </td>
                                            <td style="text-align: center"><b>{{ $row["cantidad"] }}</b></td>
                                            <td style="text-align: right">{{ number_format($row["total"],2) }}&nbsp;MXN
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right">
                                                <b>{{ number_format($data['total'],2) }}</b>&nbsp;MXN</td>
                                        </tr>
                                        @endif
