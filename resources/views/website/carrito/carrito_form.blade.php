                ...
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-warning">
                        <p style="margin:0;font-size: 12pt">
                            Es necesario ajustar la cantidad de productos en el pedido, puede realizar esta acción de
                            forma automatica,
                                    ...
                                    <th scope="col">
                                        ...
                                        <div style="padding-top: 6px;">
                                            <a href="#" class="btnAjustarTodos"><span
                                                    style="color: #56AB2B; text-decoration: underline;">Ajustar Todo
                                                </span></a>
                                            <a class="help" data-toggle="popover"
                                                title="Al hacer clic en el botón se actualiza automáticamente a la cantidad de productos disponible">
                                                <i class="icon-help"></i>
                                            </a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btnAjustar btnAjustar_{{ $item['codigoProducto'] }}"
                                            title="Ajustar Cantidad" data-existencia="{{ $aux['existencia'] ?? 0 }}"
                                            style="text-decoration:underline;">
                                            @if($aux["existencia"] > 0)
                                            <span style="font-size: 12pt; font-weight: bold; color: #FF6600;">Ajustar
                                                Cantidad</span>
                                            @else
                                            <span style="font-size: 12pt; font-weight: bold; color: #FF6600;">Sin
                                                Existencias<br>(Quitar)</span>
                                            @endif
                                        </a>
                                        @else
                                        <span class="btnAjustar_{{ $item['codigoProducto'] }}"
                                            data-existencia="{{ $aux['existencia'] ?? 0 }}"
                                            style="font-size: 16pt; font-weight: bold; color:blue;"><i
                                    ...
                                    <td>
                                        <a href="#" class="btnRemove" data-ckey="{{ $data['ckey'] }}"
...
<h3 class="text-black h4 text-uppercase">Totales</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @else
                                    <a href="#" class="btn btn-primary btn-lg btn-block btnSiguiente"
                                        data-idcliente="{{ intval(session('cliente_id')) }}"
