...
<section>
  ...
  <div style="text-align: center"><span style="color:#669933;"
  ><b>{{ request()->get("message") }}</b></span></div><br>
  @elseif(request()->get("code") == 500 && !empty(request()->get("message")))
  <div style="text-align: center"><span style="color:#CC0000;"
  ><b>{{ request()->get("message") }}</b></span></div><br>
  @elseif(!empty(request()->get("message")))
  <div style="text-align: center"><span style="color:#102360;"
  ><b>{{ request()->get("message") }}</b></span></div><br>
  @endif
       ...
       <div class="cont">
          ...
          <div class="form-outline">
            <input type="text" class="form-control form-control-lg" name="name"
              value="{{ old('name') }}"
              placeholder="Nombre"
              data-validetta="required,minLength[3]"
              style="" />
          </div>
          ...
          <div class="form-outline">
            <input type="text" class="form-control form-control-lg noSpace" name="phone"
              ...
              data-validetta="required,minLength[10],maxLength[10],number"
              style="" />
          </div>

          <div class="form-outline">
            <input type="password" class="form-control form-control-lg noSpace" name="pswd" id="txtPswd"
              placeholder="Contraseña"
              data-validetta="required,minLength[8]"
              style="" />
          </div>
          ...
          <div class="form-outline">
            <input type="password" class="form-control form-control-lg noSpace" id="txtConfirmPswd"
              ...
              data-validetta="required,equalTo[pswd],minLength[8]"
              style="" />
          </div>
