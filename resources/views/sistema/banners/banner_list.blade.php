...
@if(in_array("C_PAGINA", session("permisos")))
...
$(document).ready(function(){
  ...
  var cUrlController = "/sistema/banners";
      ...
      onLoad: function()
      {
        ...
        $pp0.on("click", ".btnForm", function(evt){
          ...
          if($table.hasClass("tblTelefono"))
          {
            ...
            var idp1 = $.crmPanel({
              href: "/sistema/menus/contacto/telefono/form/" + "?" + $.param(opts),
          ...
          if($table.hasClass("tblCorreo"))
          {
            ...
            var idp1 = $.crmPanel({
              href: "/sistema/menus/contacto/correo/form/" + "?" + $.param(opts),
              title: $(this).data("title"),
              onLoad: function()
              {
                var $pp1 = $("#"+idp1);
          ...
          if($table.hasClass("tblSintoma"))
          {
            ...
            var idp1 = $.crmPanel({
              href: "/sistema/menus/sintoma/form/" + "?" + $.param(opts),
              title: $(this).data("title"),
              onLoad: function()
              {
                var $pp1 = $("#"+idp1);
          ...
          if($table.hasClass("tblFamiliar"))
          {
            ...
            var idp1 = $.crmPanel({
              href: "/sistema/menus/familiar/form/" + "?" + $.param(opts),
              title: $(this).data("title"),
              onLoad: function()
              {
                var $pp1 = $("#"+idp1);
