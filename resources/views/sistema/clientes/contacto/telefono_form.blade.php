...
<option value="MOVIL" <?= validate_selection("MOVIL", request()->get('clave')) ?>>Móvil</option>
<option value="CASA" <?= validate_selection("CASA", request()->get('clave')) ?>>Casa</option>
<option value="TRABAJO" <?= validate_selection("TRABAJO", request()->get('clave')) ?>>Trabajo</option>
<option value="OTRO" <?= validate_selection("OTRO", request()->get('clave')) ?>>Otro</option>
</select>
</div>
</div>
