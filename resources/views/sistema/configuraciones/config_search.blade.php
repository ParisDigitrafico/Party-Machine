<form action="/sistema/usuarios/" method="get" style="padding:0; height: 100%;">
...
<input type="text" name="b[user]" value="{{ $b['user'] }}" class="form-control">
</div>
</div>
...
<input type="text" name="b[nombre]" value="{{ $b['nombre'] }}" class="form-control">
</div>
</div>
...
<input type="text" name="b[apellidos]" value="{{ $b['apellidos'] }}" class="form-control">
</div>
</div>
