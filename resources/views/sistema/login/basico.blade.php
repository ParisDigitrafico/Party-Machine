...
<head>
    ...
    <link href="/static/sistema/libs/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet"
        media="all">
                        ...
                        <div class="login-form">
                            <form id="frmLogin" action="/sistema/home/">
                                ...
                                <div class="form-group">
                                    <!--<label></label>      -->
                                    <input class="au-input au-input--full" id="txtUser" type="email"
                                        placeholder="Correo Electrónico">
                                </div>
                                <div class="form-group">
                                    <!--<label>Contraseña</label>   -->
                                    <input class="au-input au-input--full" id="txtPass" type="password"
                                ...
                                <div class="login-checkbox">
                                    ...
                                    <label>
                                        <a href="forgot/" style="color: #FF0033">¿Olvid&oacute; su
                                            contrase&ntilde;a?</a>
                                    </label>
                                </div>
                                <button class="au-btn au-btn--block au-btn--green m-b-20 btnSubmit"
                                    style="background-color: #FF7900" type="submit">Aceptar</button>
    ...
    $(document).ready(function() {
        $(document).on("click", ".btnSubmit", function(evt) {
            ...
            var objAux = {
                ...
                "txtUser": CryptoJS.AES.encrypt($form.find("#txtUser").val(), _cSecretKey)
                .toString(),
                "txtPass": CryptoJS.AES.encrypt($form.find("#txtPass").val(), _cSecretKey)
                .toString(),
                "optRmbr": CryptoJS.AES.encrypt(($form.find("#optRmbr").is(':checked') ? "1" : "0"),
                    _cSecretKey).toString(),
            };
