...
@if(in_array("C_SERVICIO", session("permisos")))
...
<th data-priority="2">Creado por</th>
...
$(document).ready(function(){
  ...
  var cUrlController = "/sistema/servicios";
      ...
      onLoad: function()
      {
        ...
        $pp0.on("click", ".btnForm", function(evt){
          ...
          if($table.hasClass("tblTelefono"))
          {
            ...
            var idp1 = $.crmPanel({
              href: cUrlController + "/contacto/telefono/form/" + "?" + $.param(opts),
          ...
          if($table.hasClass("tblCorreo"))
          {
            ...
            var idp1 = $.crmPanel({
              href: cUrlController + "/contacto/correo/form/" + "?" + $.param(opts),
              title: $(this).data("title"),
              onLoad: function()
              {
                var $pp1 = $("#"+idp1);
          ...
          if($table.hasClass("tblSintoma"))
          {
            ...
            var idp1 = $.crmPanel({
              href: cUrlController + "/sintoma/form/" + "?" + $.param(opts),
              title: $(this).data("title"),
              onLoad: function()
              {
                var $pp1 = $("#"+idp1);
          ...
          if($table.hasClass("tblFamiliar"))
          {
            ...
            var idp1 = $.crmPanel({
              href: cUrlController + "/familiar/form/" + "?" + $.param(opts),
              title: $(this).data("title"),
              onLoad: function()
              {
                var $pp1 = $("#"+idp1);
